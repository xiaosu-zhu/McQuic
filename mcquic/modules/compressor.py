...
class Neon(BaseCompressor):
    def __init__(self, channel: int, m: List[int], k: List[int], *_, **__):
        encoder = nn.Sequential(
            ...
            conv3x3(3, channel),
            AttentionBlock(channel),
            ResidualBlock(channel, 10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockWithStride(10 * channel, 10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockWithStride(10 * channel, 10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockWithStride(10 * channel, 10 * channel),
            AttentionBlock(10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            # ResidualBlock(320, 640),
            # ResidualBlockWithStride(320, 640),
            # ResidualBlock(640, 640),
            ResidualBlock(10 * channel, 20 * channel),
            ResidualBlock(20 * channel, 20 * channel),
            ResidualBlock(20 * channel, 10 * channel),
            ResidualBlock(10 * channel, channel),
            AttentionBlock(channel),
        )
        decoder = nn.Sequential(
            AttentionBlock(channel),
            ...
            AttentionBlock(10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockShuffle(10 * channel, 10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockShuffle(10 * channel, 10 * channel),
            ResidualBlock(10 * channel, 10 * channel),
            ResidualBlockShuffle(10 * channel, 10 * channel),
        ...
        quantizer = ResidualBackwardQuantizer(channel, m, k)
        super().__init__(encoder, quantizer, decoder)
