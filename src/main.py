...
flags.DEFINE_string("port", "29936", "MASTER_PORT of DistributedDataParallel.")
...
def main(_):
    if FLAGS.eval:
        ...
        mp.spawn(train, (worldSize, FLAGS.port, config, saveDir, FLAGS.r, FLAGS.debug), worldSize) # type: ignore
